...
- [agenthatch](https://github.com/agenthatch/agenthatch) - 将 Agent 技能编译为独立运行的 AI 智能体——Skill 孵化 Agent，拥有独立 PlanLayer 状态机、经验证的工具执行和隔离运行时。3 阶段编译流水线（确定性解析、6-Harness LLM 推理、代码生成）。Python 3.11+，MIT 协议。10,000+ PyPI 下载。 ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fagenthatch%2Fagenthatch&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
