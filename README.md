...
- [AICraft](https://github.com/Easlie114514/AICraft) - 🇨🇳 Desktop AI capability launcher — manage LLM Skills, MCP tools, RAG, and memory like loading Minecraft mods. One-click DeepSeek setup, role emotion portraits, 3-tier memory, portable exe.
