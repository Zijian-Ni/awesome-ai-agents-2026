...
- [Genesys](https://github.com/Astrix-Labs/genesys) - 🆕 ⚠️ **Unverified** (early-stage). Open-source causal-graph memory for AI agents (AGPL-3.0): memories are nodes, edges capture causal relationships, and a multiplicative scoring model drives lifecycle transitions and active forgetting; MCP-native (13 tools). Author-reported 85.55 on LoCoMo (10 runs, frozen gpt-4o-mini) — public harness [Astrix-Labs/locomo-harness](https://github.com/Astrix-Labs/locomo-harness). ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FAstrix-Labs%2Fgenesys&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
