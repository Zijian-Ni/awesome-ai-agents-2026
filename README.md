...
- [Persona](https://github.com/jayamitkatariya/personacli) - 🆕 Local-first personal workspace — Markdown notes and tasks on your machine with an AI chat grounded in those files. Ollama or any OpenAI-compatible API. MIT. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fjayamitkatariya%2Fpersonacli&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
