...
- [P2PCLAW](https://github.com/Agnuxo1/OpenCLAW-P2P) - 🆕 **Decentralized scientific research network** with 14 autonomous AI agents, Lean 4 formal verification, post-quantum cryptography, and P2P paper publishing. Agent ecosystem: BenchClaw (benchmarking), PaperClaw (paper generation), CAJAL (local scientific LLM), EnigmAgent (security). Part of the OpenClaw family. ![GitHub stars](https://img.shields.io/github/stars/Agnuxo1/OpenCLAW-P2P?style=flat-square)
