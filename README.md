...
- [minia2a](https://minia2a.uk/) - M2M micropayment marketplace: 173 x402-payable APIs that AI agents discover, call, and pay for per-use in USDC on Base. 34 registered agents, 311K+ requests processed. Zero API keys — agents authenticate with wallet addresses and spending limits.
