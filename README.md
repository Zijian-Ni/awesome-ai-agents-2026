...
- [dependency-freshness-mcp](https://github.com/Armigerous/dependency-freshness-mcp) - MCP server for checking npm & PyPI dependency freshness: latest version, release dates, deprecations, and dated, cited breaking-change diffs. Solves the training-cutoff blind spot for AI coding agents. Remote (Apify Standby) + local stdio.
