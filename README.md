...
- [AOTrust](https://github.com/GitSerge-crypto/aotrust-skills) - Cryptographic notarization service for AI agents: Ed25519-signed provenance receipts (PDR) for agent outputs and artifacts, anchored daily to NEAR mainnet, verifiable offline via open-source parser; MCP server (5 tools), Python SDK on PyPI, GitHub Action. ![GitHub stars](https://img.shields.io/github/stars/GitSerge-crypto/aotrust-skills?style=flat-square)
