...
- [Agon](https://github.com/AutoResearch-Factory/Agon) - Autonomous omnidisciplinary research orchestrator built on Prompt Economy. Scientist/coder/auditor loop architecture with 18 roles across 230.6 KiB of prompts — the most compact prompt surface among comparable systems. Deployed across 10+ disciplines with 30-day continuous autonomous runs. Built as a Claude Code plugin. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FAutoResearch-Factory%2FAgon&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [PerspectiveGap](https://github.com/AutoResearch-Factory/PerspectiveGap) - 🆕 First benchmark for multi-agent orchestration prompt writing. 110 scenarios across 10 communication topologies (chain, star, tree, mesh, etc.), testing whether LLMs can write prompts that make agents coordinate effectively. Measures role-fragment assignment, information leakage, and topology-aware prompt design. [Paper](https://arxiv.org/abs/2606.08878) ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FAutoResearch-Factory%2FPerspectiveGap&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
