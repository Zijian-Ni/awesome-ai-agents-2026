...
- [Agent Contract Drift Sweeper](https://github.com/Rob-Claw/agent-contract-drift-sweeper) - Pre-deploy drift detection for agent teams. Clusters stale references across prompts, API routes, docs, and UI after schema or prompt changes, with severity-based triage to prevent silent runtime failures.
