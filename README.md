...
- [BitFun](https://github.com/GCWing/BitFun) - Open-source Rust/Tauri coding agent with desktop and CLI surfaces, configurable model endpoints, Plan mode, Deep Review, and remote control. ![GitHub stars](https://img.shields.io/github/stars/GCWing/BitFun?style=flat-square)
