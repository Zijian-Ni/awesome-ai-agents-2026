...
- [YYLO](https://github.com/yylo-dev/yylo) - 🆕 ⚠️ **Unverified** (57 GitHub stars; npm `@yylo/cli`; team self-submission). Command-line orchestrator for coding agents, repeatable workflows, and receipt-backed repository changes: `task start` creates a dedicated branch/worktree per task, and the merge queue owns risk-based review behind typed task, validation, merge, and release-readiness boundaries. MIT. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fyylo-dev%2Fyylo&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
